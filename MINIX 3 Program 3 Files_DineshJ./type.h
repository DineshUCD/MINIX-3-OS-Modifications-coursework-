...
/* Memory info from PM */
struct pm_mem_info {
  struct hole pmi_holes[NR_HOLES]; /* memory (un)allocations */
...
extern struct hole hole[NR_HOLES];
extern struct hole *hole_head;
extern phys_clicks swap_base;
#endif /* _TYPE_H */
